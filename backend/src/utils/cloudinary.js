 ...
 */
export async function uploadImage(buffer, folder = 'user-products') {
    ...
    function doUpload(buf, resolve, reject) {
 ...
 */
export async function uploadLottie(buffer, folder = 'lottie') {
    return new Promise((resolve, reject) => {
        let fileBuffer;
        if (Buffer.isBuffer(buffer)) {
            fileBuffer = buffer;
