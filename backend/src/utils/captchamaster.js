...
class CaptchaMasterService {
    ...
    constructor() {
        ...
        if (!apiKey) {
            throw new CaptchaMasterError('CAPTCHAMASTER_API_KEY environment variable is not configured');
        }
        this.apiKey = apiKey;
    ...
    async getStats() {
        ...
        const response = await this.client.get('/reseller/stats');
    ...
    async getPricingPlans() {
        ...
        const response = await this.client.get('/reseller/pricing-plans');
        const result = response.data;
    ...
    async getPackages() {
        ...
        const response = await this.client.get('/reseller/packages');
        const result = response.data;
    ...
    async deletePackage(id) {
        ...
        const response = await this.client.delete(`/reseller/packages/${id}`);
        const result = response.data;
        if (!result.success) {
    ...
    async getApiKeys() {
        ...
        const response = await this.client.get('/reseller/api-keys');
        const result = response.data;
    ...
    async createApiKey(name) {
        ...
        const response = await this.client.post('/reseller/api-keys', { name });
        const result = response.data;
    ...
    async regenerateApiKey(id) {
        ...
        const response = await this.client.put(`/reseller/api-keys/${id}/regenerate`);
        const result = response.data;
        if (!result.success || !result.apiKey) {
    ...
    async deleteApiKey(id) {
        ...
        const response = await this.client.delete(`/reseller/api-keys/${id}`);
        const result = response.data;
        if (!result.success) {
     ...
     */
    async purchasePackage(planId, customerEmail) {
        if (!planId) {
        ...
        const response = await this.client.post(`/reseller/purchase/${planId}`, { customerEmail });
        const result = response.data;
...
// Singleton instance
let instance = null;
export function getCaptchaMasterService() {
    if (!instance) {
...
export function resetCaptchaMasterService() {
    instance = null;
}
export default CaptchaMasterService;
//# sourceMappingURL=captchamaster.js.map