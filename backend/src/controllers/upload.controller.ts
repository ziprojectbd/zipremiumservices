import { uploadImage, uploadLottie } from '@utils/cloudinary';
 ...
 */
function bufferToFileLike(buffer: Buffer): { arrayBuffer: () => Promise<ArrayBuffer> } {
  return {
    arrayBuffer: async () => {
 ...
 */
function isLottieFile(file: Express.Multer.File): boolean {
